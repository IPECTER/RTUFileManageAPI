...
public class YAMLFile extends StorageFile {
     ...
     */
    public YAMLFile(Plugin plugin, String directory, String fileName, Integer fileVersion, boolean resetFile, List<String> ignoredNodes, List<String> replaceNodes) {
